...
For wide format, each variable has its own column. 
For long format, each observation has one column for variable name and one for value.

Is the format `staff` data *wide* or *long*?
It is wide because each year is a column representing a variable (1975, 1989, 1993, …).

How many observations are there in the data set?
There are 55 observations in the data set: "Full-Time Tenured Faculty", "Full-Time Tenure-Track Faculty", "Full-Time Non-Tenure-Track Faculty", "Part-Time Faculty", "Graduate Student Employees"
